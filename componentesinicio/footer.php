<?php
 echo'<footer>
     <ul class="redes">
     <li><a href="https://facebook.com"><ion-icon class="redes" name="logo-facebook"></ion-icon></a></li>
     <li><a href="https://instagram.com"><ion-icon class="redes" name="logo-instagram"></ion-icon></a></li>
